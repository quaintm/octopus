...
def upgrade():
    ...
    op.create_index(op.f('ix_case_types_code'), 'case_types', ['code'], unique=True)
    op.create_index(op.f('ix_case_types_description'), 'case_types', ['description'], unique=False)
    ...
    op.create_index(op.f('ix_case_tag_map_case_id'), 'case_tag_map', ['case_id'], unique=False)
    op.create_index(op.f('ix_case_tag_map_tag_id'), 'case_tag_map', ['tag_id'], unique=False)
    ...
    op.create_index(op.f('ix_case_staff_map_case_id'), 'case_staff_map', ['case_id'], unique=False)
    op.create_index(op.f('ix_case_staff_map_user_id'), 'case_staff_map', ['user_id'], unique=False)
