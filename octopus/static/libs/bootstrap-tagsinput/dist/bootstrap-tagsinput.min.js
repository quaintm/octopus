...
!function (a) {
  ...
  b.prototype = {
    constructor: b, add: function (b, c) {
      var d = this;
        ...
        if (!b.toString().match(/^\s*$/)) {
          ...
          if (!k || d.options.allowDuplicates) {
            if (!(d.items().toString().length + b.length + 1 > d.options.maxInputLength)) {
              var l = a.Event("beforeItemAdd", {item: b, cancel: !1});
              if (d.$element.trigger(l), !l.cancel) {
                ...
                c || d.pushVal(), (d.options.maxTags === d.itemsArray.length || d.items().toString().length === d.options.maxInputLength) && d.$container.addClass("bootstrap-tagsinput-max"), d.$element.trigger(a.Event("itemAdded", {item: b})), d.$input.typeahead("val", "")
              }
            }
      ...
      if (d.objectItems && (b = "object" == typeof b ? a.grep(d.itemsArray, function (a) {
        ...
        var e = a.Event("beforeItemRemove", {item: b, cancel: !1});
      ...
      c || d.pushVal(), d.options.maxTags > d.itemsArray.length && d.$container.removeClass("bootstrap-tagsinput-max"), d.$element.trigger(a.Event("itemRemoved", {item: b}))
    }, removeAll: function () {
      var b = this;
    ...
    return this.each(function () {
      ...
      } else e.push(f); else f = new b(this, c), a(this).data("tagsinput", f), e.push(f), "SELECT" === this.tagName && a("option", a(this)).attr("selected", "selected"), a(this).val(a(this).val())
